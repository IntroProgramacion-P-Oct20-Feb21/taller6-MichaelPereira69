...
public class Problema1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("indique las mensualidades "
                + "(ingrese minimo 2):  ");
        mensualidades= entrada.nextInt();
        if (mensualidades >= 2 ) {
        System.out.println("Que servicio de stream decea\n"
       ...
       switch (numero){
        case 1: 
               ...
               +"Empresa: Netflix\n"+ "Precio base: $%.2f\n"+"Impuesto: $%.2f\n"+"Total a cancelar: $%.2f\n",
               nombre, netflix, iva_netflix, total_netflix);
          break;case 2: 
               resultadofinal= String.format("Usuario:%s\n"+"Empresa: disney\n"+ "Precio base: $%.2f\n"+"Impuesto: $%.2f\n"+"Total a cancelar: $%.2f\n",
               nombre, disney, iva_disney, total_disney);
          break;             
        case 3: 
               resultadofinal= String.format("Usuario:%s\n"+"Empresa: apple\n"+ "Precio base: $%.2f\n"+"Impuesto: $%.2f\n"+"Total a cancelar: $%.2f\n",
               nombre,apple,iva_apple,total_apple);
          break;   
         case 4: 
               resultadofinal= String.format("Usuario:%s\n"+"Empresa: amazon\n"+ "Precio base: $%.2f\n"+"Impuesto: $%.2f\n"+"Total a cancelar: $%.2f\n",
               nombre,amazon,iva_amazon,total_amazon);
          break;                        
           }
       }else{
